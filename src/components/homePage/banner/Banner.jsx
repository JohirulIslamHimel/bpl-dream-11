...
const Banner = () => {
  return (
    <div className="mx-4 md:mx-10 my-10 p-6 md:p-10 rounded-3xl bg-linear-to-r from-[#211E31] from-10% via-[#131118] via-50% to-[#624754] to-90% flex flex-col items-center text-center ">
      {/* banner img */}
      <div className="mb-6">
        <img
          src={cricketLogoImg}
          alt="Cricket Logo with Bats and Balls"
          className="w-32 md:w-48 lg:w-56 mb-6"
        />
      </div>
      {/* heading */}
